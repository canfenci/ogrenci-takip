...
test('Scenario A: Static contract — lesson records card rendering and exports are present in finance.js', () => {
    assert.match(financeJsContent, /export function renderDersDetay/, 'renderDersDetay must be exported');
    assert.match(financeJsContent, /export function addDersKayit/, 'addDersKayit must be exported');
});
